...
class LoginHandler(BaseHandler):
	...
	Args:
            username: String: Get the username from POST dict
            password: String: Get the password from POST dict
	Bindings:
...
class CreateUserHandler(BaseHandler):
    def get(self):
        """
	      ...
	      Returns:
              	form: string: Returns a simple HTML form for create a new user
          """
        return """
			<!DOCTYPE hml>
			<html>
